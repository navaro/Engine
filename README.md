...
> :bulb: In the following debug log, 0x700 is the "Door" event and 0x701 is the "OnOff" event. The text preceded by the #################### is the debug output of the actions itself and not generated by the state machine. All other logging is generated by Engine.
